    ...
    <div className="relative min-h-screen flex items-center justify-center px-4 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xs text-slate-400 mt-2">Log in to manage your automated reporting workspaces</p>
        </div>
        ...
        <div className="glass-panel p-8 rounded-2xl border border-slate-900">
          ...
          <div className="text-center mt-6 pt-5 border-t border-slate-900 text-xs text-slate-500">
            ...
            <Link to="/register" className="text-brand-400 hover:text-brand-300 font-medium hover:underline transition">
              Create an account
            </Link>
          </div>
        </div>
